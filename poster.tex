...
\author{C. Scott Ananian \texttt{[[User:cscott]]}
  <cananian@wikimedia.org> (Wikimedia Foundation)}
...
\begin{columns}
  ...
  \block{Tor!}{%
    ...
    \begin{tikzfigure}
      \includegraphics[height=17cm]{censored-nospeaking.eps}
    \end{tikzfigure}
...
\begin{columns}
  ...
  \block{Collaborative Edit Queues}{%
    \centering\includegraphics[height=10cm]{favourite-animal.png}
...
\begin{tikzfigure}
  \includegraphics[height=12cm]{world-kids-nobg.eps}
\end{tikzfigure}
}
\end{columns}
